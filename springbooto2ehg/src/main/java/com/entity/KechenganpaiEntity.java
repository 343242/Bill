...
public class KechenganpaiEntity<T> implements Serializable {
	...
	private String shangkezt;
	
	/**
	 * 排班日期
	 */
	@TableField("paibanriqi")
	@JsonFormat(locale="zh", timezone="GMT+8", pattern="yyyy-MM-dd")
	@DateTimeFormat(pattern="yyyy-MM-dd")
	private String paibanriqi;
	 ...
	 * 设置：上课状态
	 */
	public void setShangkezt(String shangkezt) {
		this.shangkezt = shangkezt;
	}
	/**
	 * 获取：上课状态
	 */
	public String getShangkezt() {
		return shangkezt;
	}
	/**
	 * 设置：排班日期
	 */
	public void setPaiBanriqi(String paibanriqi) {
		this.paibanriqi = paibanriqi;
	}
	/**
	 * 获取：排班日期
	 */
	public String getPaiBanriqi() {
		return paibanriqi;
	}
	/**
	 * 设置：时间段
